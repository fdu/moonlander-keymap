...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYMBOLS] = LAYOUT_moonlander(
    ...
    _______, _______, BP_EACU, _______, BP_EGRV, _______, _______,           _______, _______, _______, _______, _______, _______, _______,
    _______, BP_A_GRAVE, _______, BP_ECIR, _______, _______, _______,           _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, BP_C_CEDILLA, _______, _______,                             _______, _______, _______, _______, _______, _______,
...
//    LED_LEVEL, SMILEY,VERSION, NOCTURNE, _______, _______, _______,           _______, _______, _______, _______, _______, _______, RESET,
    SONG_1,  _______, _______, _______, _______, _______, _______,           _______, _______, _______, _______, _______, _______, RESET,
